...
coordinates = [
    ...
    (51.95453220445105, 5.814545728615775),  # driel
    (52.129984048688264, 5.428032011026083)      # leusden
]

mean_point = geographic_mean(coordinates)
print("Geographic mean (longitude, latitude):", mean_point)

# print: 52.02398722771063, 5.723684051378347
# ofwel: 52°01'26.4"N 5°43'25.3"E
# ofwel: rechts van Ede naast de A12 (zeer goed bereikbaar dus)
